...
print(
    f"[smoke] effective LLM attn: {worker.model.language_model.model._attn_implementation}",
    flush=True,
)
...
t1 = time.time()
res = worker.detect(
    img, ["car", "person"], generation_mode="hybrid", max_new_tokens=256, verbose=True
)
