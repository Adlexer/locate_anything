...
| 14 | [14_tw2k_data_expansion_and_tuning.md](./14_tw2k_data_expansion_and_tuning.md) | 2026-08-16 | 两轮车闭环第二轮：数据扩充 2K + 训练调优 | 数据 120→1998（3231 教师框）；tw_run_v3（batch32/lr0.005/freeze10）在人工 GT val mAP50 0.995（v1 0.757/v2 0.504）；数据量瓶颈解决 | done |
